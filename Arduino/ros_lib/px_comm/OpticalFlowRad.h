#ifndef _ROS_px_comm_OpticalFlowRad_h
#define _ROS_px_comm_OpticalFlowRad_h
...
namespace px_comm
{
  ...
  class OpticalFlowRad : public ros::Msg
  {
    ...
    const char * getType(){ return "px_comm/OpticalFlowRad"; };
    const char * getMD5(){ return "453a7b832185e7778e3e1e99881dc48d"; };
